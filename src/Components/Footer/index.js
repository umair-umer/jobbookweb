...
import './Styles.css'
import Googleplay from '../../Assests/Googlefooter.png'
import Appstore from '../../Assests/Appstorefooter.png'
function Footer() {
    return (
        <div className='footer' style={{ marginTop: "80px" }}>
            <>
                {/* Remove the container if you want to extend the Footer to full width. */}
                <footer className="text-center text-lg-start text-white bg" style={{ backgroundColor: "#005049", textDecoration: "none" }}>
                    {/* Grid container */}
               ...
               justify-content-center mb-4 
                my-5"
                                ...
                                {/* <div className="text-start" style={{ marginRight: "180px", }}>
                                ...
                                <ul className="list-unstyled d-flex flex-row justify-content-center ms-auto">
                                    <li>
                            ...
                            <div className="col-lg-3 col-md-6 mb-4 mb-md-0 my-5">
                                <h5 className="text-uppercase mb-4 mx-3">Quick Links</h5>
                                <ul className="list-unstyled">
                                    <li className="mb-2" >
